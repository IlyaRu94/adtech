...
$print.='<img src="/images/SF-AdTech2.jpg" width="350" align="right">';	
		foreach($data as $row)
		{
			$print.='<ul class="table-list"><li class="table-list__item">Партнер: '.$row['name'].'</li><li class="table-list__item">Адрес: '.$row['adress'].'</li><li class="table-list__item">Email: '.$row['email'].'</li></ul>';
		}
$print.='<h2 class="section__h2">Как работает сервис</h2>
